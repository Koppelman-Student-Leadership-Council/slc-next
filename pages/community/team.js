        ...
        <Layout>
            ...
            <div className="grid justify-items-center pt-10 px-0 sm:mx-30 lg:px-0 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-y-10">
                {membersData.map((member) => {
                    return <div key={member.id ?? ''} className="mt-1 mb-1">
                        <MemberCard image={member.image_link} name={member.name} description={member.description} title={member.title} department={member.department} linkedin={member.linkedin} />
